      ...
      s3.putObject(videoParams, function(err, data) {
        if (err) {
          ...
          if (questionNumber === 1) {
              ...
              setGlobalVideo1Link("https://uploads-video-resumes.s3.amazonaws.com/" + data.Key);
              ...
              setGlobalVideo2Link("https://uploads-video-resumes.s3.amazonaws.com/" + data.Key);
              ...
              setGlobalVideo3Link("https://uploads-video-resumes.s3.amazonaws.com/" + data.Key);
          }
          resolve(data);
        }
      });
  ...
  const mobileForm = (
    ...
    >
      {({ setFieldValue, handleSubmit, handleChange }) => (
        <Form
          style={{ backgroundColor: "white", borderRadius: "8px", padding: "20px", width: "90%", margin: "0 auto" }}
